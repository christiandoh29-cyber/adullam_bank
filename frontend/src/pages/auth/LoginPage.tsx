...
export default function LoginPage() {
  ...
  return (
    <div className="animate-slide-up">
      ...
      {/* Demo credentials */}
      <div 
        className="mt-6 p-4 rounded-xl bg-surface-800/50 border border-theme animate-slide-up transition-all duration-300 hover:border-theme hover:bg-surface-800/70"
        style={{ 
